...
SECRET_KEY = os.environ.get(
    "THIS_API_KEY", '1u=t*=pc@9_9qd=!0d$r%r-53xu!t4=8)056%4t6$w&3(@iy4#')
'''
...
# Local static files (not to be served ever)
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]

# CDN -Content Delivert Network - "SERVING" directory
